...
private:
    ...
    void pointCb(const geometry_msgs::PointStampedConstPtr& point){
        ...
        if(waiting_for_center_){
            ...
            polygon_pub_.publish(input_.polygon);
...
public:
        ...
        waiting_for_center_(false)
    {
        ...
        point_viz_pub_ = nh_.advertise<visualization_msgs::Marker>("exploration_polygon_marker", 10, true);
        polygon_pub_ = nh_.advertise<geometry_msgs::Polygon>("/boundary", 10, true);
